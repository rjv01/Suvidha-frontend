		...
		<div>
			...
			>
				<ReactBootStrap.Navbar.Brand className="brand-logo">
					<Link to="/" style={{ color: "inherit", textDecoration: "none", fontSize: " 2.5rem" }}>
						⚒️Suvidha
					</Link>
					...
					{isWorker || isCustomer ? (
						<>
							<ReactBootStrap.Button
								...
								className="btn bg-white text-dark btn-lg "
							>
								Sign out
							</ReactBootStrap.Button>
						</>
						...
						<>
							{" "}
							<Link to="/sign_in" className="btn  btn-lg bg-white text-dark">
								Sign In
							</Link>
						</>
					)}
